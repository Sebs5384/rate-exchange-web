describe("Exchange table testing", () => {
  ...
  beforeEach(() => {
    cy.visit(URL);
    cy.intercept("GET", "https://api.exchangerate.host/latest?base=EUR&places=2", { fixture: "default-exchange" }).as("defaultExchange");
  });
  ...
  it("Should display the exchange rates of the selected currency and date", () => {
    cy.intercept("GET", "https://api.exchangerate.host/2020-01-01?base=ARS&places=2", { fixture: "exchange" }).as("exchange");
